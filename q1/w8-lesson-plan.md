...
id: 019e1770-e37f-7b10-827e-aaffa46bd2f9
---
# Q1 · Week 8 · Session-by-Session Lesson Plan

## Carry-forward from Week 7

Two open issues flagged in `w7-backprop-explainer.md` (v0.6) that belong in S4 this week:
...
Pull up `w6s2-code.py`. The 3-class toy dataset, `MLP`, and `mini_batch` training loop are your starting point. You'll be extending, not rewriting.
...
Open `w7-backprop-explainer.md` (or your current working version). Before writing anything new:
...
Add a short section to `w7-backprop-explainer.md` (which will become v0.6.1 or your numbering convention):
