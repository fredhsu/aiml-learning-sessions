...
id: 019e1770-e3b8-7481-99f9-29149f187506
---
# Week 8 Session 2

The full code for this session is in:
[SGD and MomentumSGD with decay](w8s2-code.py)
...
The second exercise was to create a split of training and validation data and use that to both train and validate the loops. This was done in the higher level code building on `w6s2-code.py`:
