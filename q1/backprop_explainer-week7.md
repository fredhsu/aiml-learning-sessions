...
Since $0<\beta<1$ we weigh the more recent values more heavily than the older ones and the gradient components along the high-curvature eigendirection. The EMA will tend to cancel these out because they flip sign while the consistent component accumulates.
